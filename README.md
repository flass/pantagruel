...
```  
the `init_file` can be generated by editing **a copy** of the [template environment script](https://github.com/flass/pantagruel/scripts/pipeline/environ_pantagruel_template.sh). Note than it is only safe to edit the top parameters.
