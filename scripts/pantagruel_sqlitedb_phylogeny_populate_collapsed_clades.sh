...
if [ -z $database ] ; then
 ...
 echo "database=$1 dbfile=$2 colalinexuscodedir=$3 coltreechains=$4 collapsecond=$5 replmethod=$6 collapsecriteriondef=$7 collapsecolid=$8 replacecolid=$9 collapsecoldate=$10 replacecoldate=$11"
 exit 1
fi
