...
echo "This is the 'usingGeneRax' branch of Pantagruel pipeline; using this module that runs 'ALE' reconciliation method instead of 'GeneRax' may result into data that are incompatible with downstream modules."
